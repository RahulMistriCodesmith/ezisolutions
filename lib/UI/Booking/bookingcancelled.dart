...
import 'package:ezisolutions/UI/Booking/rate&review.dart';
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('CANCELLED',style: Textstyle2Light18.appbartextstyle.copyWith(
                                fontWeight: FontWeight.w600,fontSize: 15,color: Appcolors.red
                            ),),
                            SizedBox(height: 10),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(child: SizedBox()),
                            Text('RM 3.60',style: Textstyle2Light18.appbartextstyle.copyWith(
                              fontWeight: FontWeight.w600,fontSize: 15,
                            ),),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            Text('Total Refund',style: Textstyle2Light18.appbartextstyle.copyWith(
                                fontWeight: FontWeight.w700,fontSize: 15,color: Appcolors.grey1
                            ),),
                            Expanded(child: SizedBox()),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Cancellation Remarks',style: Textstyle2Light18.appbartextstyle.copyWith(
                            fontWeight: FontWeight.w600,fontSize: 15,
                          ),),
                          Text('Not able to make it.',style: Textstyle2Light18.appbartextstyle.copyWith(
                            fontWeight: FontWeight.w400,fontSize: 15,
                          ),),
